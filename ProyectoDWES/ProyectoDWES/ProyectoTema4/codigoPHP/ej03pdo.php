    ...
    <body>
        ...
        if ($entradaOK) { //Si la entrada de datos es correcta se imprimen por pantalla los campos.
            ...
            try {
                ...
                if ($consulta->execute()) {
                    echo "El departamento con el código ".$aFormulario[codigoDepartamento]." fue registrado"; //Si el registro fue correcto muestra el mensaje.
                } else {
                    echo "No pudo registrarse el departamento"; //Muestra el mensaje si no se ha podido realizar la inserción.
                }
